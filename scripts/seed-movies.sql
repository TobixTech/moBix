-- Complete seed script for easy database population
-- Insert sample movies (using ON CONFLICT to avoid duplicates)
...
-- Initialize ad settings if not exists
INSERT INTO "AdSettings" ("horizontalAdCode", "verticalAdCode", "homepageEnabled", "movieDetailEnabled", "dashboardEnabled")
